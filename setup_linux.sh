#!/bin/bash
# EmmaSarmingStore - Linux Setup & Build Script
...
echo "============================================"
echo "  EmmaSarmingStore v2 - Linux Setup Script"
echo "============================================"
...
venv/bin/pyinstaller EmmaStore.spec --clean --noconfirm
...
echo "============================================"
echo ""
echo "  Production build: dist/EmmaStore/EmmaStore"
echo ""
echo "  To run the app:"
echo "    Production:  ./dist/EmmaStore/EmmaStore"
