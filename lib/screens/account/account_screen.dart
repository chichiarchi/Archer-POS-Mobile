...
class AccountScreenState extends State<AccountScreen> {
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () async {
                ...
                final success =
                    await DatabaseHelper.instance.createUser(uname, pwd, role);
                if (success) {
                  await DatabaseHelper.instance.logAction(
                    'USER_CREATE',
                    details:
                        'Admin ${widget.username} created user account: $uname ($role)',
                  ...
                  _showSnackBar('Username already exists or creation failed.',
                      isError: true);
                }
              },
              child: Text('Create',
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text('Delete User',
            style: GoogleFonts.inter(fontWeight: FontWeight.w800)),
        content: Text(
            'Are you sure you want to delete user "$uname"? This cannot be undone.'),
        actions: [
          TextButton(
  ...
  void _showChangeUserPasswordDialog(String uname) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
        title: Text('Change Password for $uname',
            style: GoogleFonts.inter(fontWeight: FontWeight.w800)),
        content: TextField(
          controller: passController,
          obscureText: true,
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              ...
              final success =
                  await DatabaseHelper.instance.updatePassword(uname, pwd);
              if (success) {
                await DatabaseHelper.instance.logAction(
                  'USER_PASSWORD_RESET',
                  details:
                      'Admin ${widget.username} reset password for user: $uname',
                  userId: widget.username,
                );
                Navigator.of(ctx).pop();
  ...
  Future<void> _updatePassword() async {
    ...
    try {
      ...
      final user = await DatabaseHelper.instance
          .verifyLogin(widget.username, currentPassword);
      if (user == null) {
      ...
      if (result != null && result.files.single.path != null) {
        ...
        final confirmed = await showDialog<bool>(
          ...
          builder: (ctx) => AlertDialog(
            shape:
                RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
            title: Text('Import Products Only',
                style: GoogleFonts.inter(fontWeight: FontWeight.w800)),
            content: Text(
        ...
        if (confirmed == true) {
          ...
          await DatabaseHelper.instance
              .importProductsFromExternalDb(selectedPath);
  ...
  Future<void> _exportDatabase() async {
    try {
      ...
      final sourcePath = p.join(dbPath, 'emma_store.db');
      ...
      if (selectedDirectory != null) {
        final targetPath = p.join(selectedDirectory, 'emma_store_backup.db');
  ...
  Widget build(BuildContext context) {
    final roleDisplay = widget.userRole.toLowerCase() == 'admin'
        ? 'Administrator'
        : 'Staff Cashier';
    ...
    final sectionSubStyle = GoogleFonts.inter(
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          'My Account Settings',
          style: GoogleFonts.inter(
              fontWeight: FontWeight.w800, fontSize: 22, color: cs.onSurface),
        ),
                ...
                child: Column(
                  ...
                  children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (_loadingUsers)
                                ...
                                Text('No additional users found.',
                                    style: GoogleFonts.inter(
                                        color:
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 4),
                            Text(
                                'Export your database to back up your data, or import a database file to pre-populate products.',
                                style: sectionSubStyle),
                            const Divider(height: 28),
                            Row(
                              children: [
                    ...
                    ElevatedButton.icon(
                      ...
                      label: Text('SIGN OUT OF EMMASTORE',
                          style: GoogleFonts.inter(
